...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">  
                    ...
                    <script src="https://www.paypal.com/sdk/js?client-id=AS0FbFf-WgpYHAXZ-ygXOtfgrcRhtuM2qC5S4GdOjwMZ-yi_37WJRxhc2n0rNjRONnNWnEKVzzw7Z0L7&currency=USD"></script>
                    ...
                    <script>
                        ...
                        createOrder: (data, actions) => {
                            ...
                            purchase_units: [{
                                amount: {
                                value: '<?php echo $singleProduct->price; ?>' // Can also reference a variable or function
                                }
                            }]
                            });
                        },
